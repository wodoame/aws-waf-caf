...
1. 
**AWS Well-Architected Framework (WAF):** I use this to evaluate and improve the workload across five pillars: Operational Excellence, Security, Reliability, Performance Efficiency, and Cost Optimization.


2. 
**AWS Cloud Adoption Framework (CAF):** I use this to analyze organizational readiness across Business, People, Governance, Platform, Security, and Operations perspectives.
